...
## How to Run
1. For detailed instructions, please refer to the [**DeepASMM Manual**](https://github.com/Jie-Lii/DeepASMM/tree/main/DeepASMM#readme) in this repository.
...
3. **Demo examples** are available at [**DeepASMM Demos**](https://github.com/Jie-Lii/DeepASMM/tree/main/demos/). 
